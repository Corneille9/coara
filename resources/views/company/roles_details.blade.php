    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Details du Roles
                ...
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Gérer les Utilisateurs</li>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <!--begin::User details-->
                                    <div class="d-flex flex-column">
                                        <a href="../users/view.html" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
...
@section("script")
    <script src="{{asset($resolved_assets."app/assets/js/custom/apps/user-management/roles/list/add.js")}}"></script>
    <script src="{{asset($resolved_assets."app/assets/js/custom/apps/user-management/roles/list/update-role.js")}}"></script>
@endsection
