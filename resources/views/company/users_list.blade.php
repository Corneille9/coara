    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Liste des Utilisateurs
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Authentification à double facteur</th>
                        <th class="min-w-125px">Date d'Ajout</th>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                <a href="{{route("app.company.user.details")}}">
                                    <div class="symbol-label">
                                        <img src="{{asset($resolved_assets."app/assets/media/avatars/150-1.jpg")}}" alt="Emma Smith" class="w-100" />
                                    </div>
                                </a>
                            </div>
                            <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-column">
                                <a href="{{route("app.company.user.details")}}" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                        ...
                        <!--begin::Last login=-->
                        <td>
                            <div class="badge badge-light fw-bolder">Hier</div>
                        </td>
                        <!--end::Last login=-->
                        <!--begin::Two step=-->
                        <td></td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route("app.company.user.details")}}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="{{route("app.company.user.details")}}" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
...
@section("script")
    <script src="{{asset($resolved_assets."app/assets/js/custom/apps/user-management/users/list/table.js")}}"></script>
    <script src="{{asset($resolved_assets."app/assets/js/custom/apps/user-management/users/list/export-users.js")}}"></script>
    <script src="{{asset($resolved_assets."app/assets/js/custom/apps/user-management/users/list/add.js")}}"></script>
@endsection
