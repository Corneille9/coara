            ...
            <div class="col-md-4">
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-footer flex-wrap pt-0">
                        <a href="{{route("app.company.role.details")}}" class="btn btn-light btn-active-primary my-1 me-2">View Role</a>
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-body d-flex flex-center">
                        ...
                        <button type="button" class="btn btn-clear d-flex flex-column flex-center" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">
                            <!--begin::Illustration-->
                            <img src="{{asset($resolved_assets."app/assets/media/illustrations/sigma-1/4.png")}}" alt="" class="mw-100 mh-150px mb-7" />
                            <!--end::Illustration-->
                            <!--begin::Label-->
